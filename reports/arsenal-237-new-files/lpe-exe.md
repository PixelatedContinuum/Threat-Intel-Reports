...
what it implies about the rest of the chain.

This is a wrapper, not a payload. It takes another executable as an argument and runs it as
SYSTEM, which means a detection here is a detection of the hinge between an ordinary user
...
that preceded it is still unaccounted for.
