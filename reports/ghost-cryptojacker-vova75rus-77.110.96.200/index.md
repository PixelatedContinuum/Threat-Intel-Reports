...
3. **Personal-dedication page** `Для Арины 💖 С 8 Марта` ("For Arina 💖 March 8th" — Russian Women's Day) on `Vova75Rus/Notes.github.io`. Wayback Machine preserved before GitHub T&S suspension. Personal-attribution artifact consistent with single-individual ownership.
...
- `https://github.com/Vova75Rus/Notes.github.io` (personal-dedication page, "Для Арины 💖 С 8 Марта")
...
- **Vova75Rus real-world identity** — handle + region indicator + Arina dedication page only. Real-world identity attribution would require Tier-1 government attribution or substantial multi-Tier-2 vendor convergence.
