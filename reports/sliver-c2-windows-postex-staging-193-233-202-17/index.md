...
That is the shape of what follows. Where this report describes an artifact that is already public, it describes what the artifact is and what it does, and it does not dress it up as a discovery.
...
Whether the resolver contract is still actively maintained is undecided by design. No public reporting has re-examined it since 2026-08-04. That is an absence of reporting rather than evidence of dormancy, and it cuts both ways equally, which is why this report describes the contract's history in the past tense and makes no claim about its present status. The last observed write is the one dated 2026-07-01.
