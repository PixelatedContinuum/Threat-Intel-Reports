...
<div class="hl-page-header" style="--ph-accent: #f472b6;">
...
<div class="hl-feat-grid">
  <div class="hl-feat" style="--fa: #58a6ff;">
    ...
    <div class="hl-feat__stat">Multiple days</div>
    <p class="hl-feat__desc">Smaller reports: static + dynamic malware analysis, infrastructure pivoting, detection development, and write-up.</p>
  </div>
  <div class="hl-feat" style="--fa: #f97316;">
    <div class="hl-feat__dot"></div>
    <div class="hl-feat__stat">A month or more</div>
    <p class="hl-feat__desc">Major investigations like the Arsenal-237 and Zero Trace series: many samples and extensive hunting pivots.</p>
  </div>
  <div class="hl-feat" style="--fa: #4ade80;">
    <div class="hl-feat__dot"></div>
    <div class="hl-feat__stat">Out of pocket</div>
    <p class="hl-feat__desc">A dedicated, self-built home lab runs the VMs, sandboxes, and tooling for safe analysis, at real hardware and operating cost.</p>
  </div>
</div>

<p style="color: var(--hl-text-muted); font-size: 0.85em; line-height: 1.6; margin-top: 16px;">None of it is paywalled, because the research is more valuable when it reaches defenders directly. But it is not free to produce.</p>
...
<div class="hl-grid-2">
  <a class="hl-link-card" style="--acc: #58a6ff;" href="{{ '/consulting/' | relative_url }}">
    <div class="hl-link-card__title">Consulting &amp; Advisory&nbsp;&rarr;</div>
    <p class="hl-link-card__desc">Threat-model reviews, retainer advisory, and custom research scoped to your environment and threat profile, not generic frameworks.</p>
  </a>
  <a class="hl-link-card" style="--acc: #b8902f;" href="{{ '/sponsor/' | relative_url }}">
