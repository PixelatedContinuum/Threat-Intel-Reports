...
|---|---|---|---|---|
| YARA | 0 | 0 | — | 0 |
| Sigma | 4 documents (1 bundle) | 0 | T1685, T1068 | 0 |
| Suricata | 0 | 0 | — | 0 |
...
- **Tags verified, not assumed.** T1685 plus the `attack.defense-impairment` tactic tag (the ATT&CK v19 replacement for the old T1685 sub-technique tree) were already used correctly in two of the three source rules. Final tags across all rules were confirmed against the real `sigma check` validator rather than left as drafted.
