...
Every report on this site starts with hands-on analysis: sandbox runs, static examination, behavioral observation, network captures. What comes out the other end is structured, evidence-based intelligence written to be technically deep enough to trust and clear enough to act on. Not surface-level summaries, and not dense academic papers, but something in between that a SOC analyst, detection engineer, or threat hunter can actually use.
...
> This is original research, not a collection of open-source intel reports, IOCs, or TTPs. Findings are from my own analysis, though they may overlap with known threats. Looking for an open-source collection? Reach out and I can point you in the right direction.
...
- Or reach out directly, and I'm happy to collaborate and post on your behalf as co-author
...
Reports are © 2026 Joseph, The Hunters Ledger, licensed under CC BY 4.0, free to republish and adapt, including commercially, with attribution.

Detections and IOC feeds are licensed under Creative Commons Attribution 4.0 International (CC BY 4.0), free to use, including commercially, with attribution required.
